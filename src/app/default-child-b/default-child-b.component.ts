...
@Component({
  selector: 'app-default-child-b',
  templateUrl: './default-child-b.component.html',

})
export class DefaultChildBComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {

  public readonly title = 'default-child-b';
