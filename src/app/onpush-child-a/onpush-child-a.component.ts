...
@Component({
  selector: 'app-onpush-child-a',
  templateUrl: './onpush-child-a.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class OnpushChildAComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {

  public readonly title = 'onpush-child-a';
