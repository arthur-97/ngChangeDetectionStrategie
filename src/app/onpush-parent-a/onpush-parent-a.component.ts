...
@Component({
  selector: 'app-onpush-parent-a',
  templateUrl: './onpush-parent-a.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class OnpushParentAComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {

  public readonly title = 'onpush-parent-a';
