...
@Component({
  selector: 'app-default-parent-b',
  templateUrl: './default-parent-b.component.html',

})
export class DefaultParentBComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {

  public readonly title = 'default-parent-b';
